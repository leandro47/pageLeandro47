...
<main class="site-main">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 about-title">
                    ...
                    <div class="paragraph py-4 w-75">
                        ...
                        <p class="para">
                            I live in Mafra-SC, I'm 22 years old, currently I'm single, graduated in ADS, currently working as a fullstack programmer and supporting Mercedes-Benz for two years,
    ...
    <section class="services-area" id="education">
        <div class="container fluid">
            ...
            <hr>
            <div class="container-fluid">
                <p class="text-uppercase title-text text-center title-session">Tecnologies</p>
                <div class="row">
                    <!-- php  -->
